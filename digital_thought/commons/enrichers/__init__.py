from digital_thought.commons import logging as logger
from digital_thought.commons.enrichers.ip_address_domain_details import IPAddressDomainInfo
from digital_thought.commons.converters import json as json_flattener
import logging
import argparse
import pathlib
import os
...
def main():
    ...
    arg_parser = argparse.ArgumentParser(prog='python -m commons.enrichers',
